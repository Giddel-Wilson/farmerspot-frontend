        ...
        <section className="flex flex-col items-center">
          {user._id !== undefined ? (
            <>
              ...
              {user.phone && <h6>{`+234 ${user.phone}`}</h6>}
              ...
              <div className="flex gap-3 mt-4">
                {appState.isCustomer() && (
                  <button
                    ...
                    className="px-6 py-2.5 bg-gradient-to-r from-premium-500 to-premium-600 hover:from-premium-600 hover:to-premium-700 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
                  >
                    My Orders
                  </button>
                )}
                ...
                {appState.isAdmin() && (
                  <button
                    ...
                    className="px-6 py-2.5 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
                  >
                    Admin Dashboard
                  </button>
                )}
